...
public:
    ...
    bool jtag_scan = false;
    bool jtag_program = false;
...
protected:
    ...
    void send_JTAG_configuration_values_html(AsyncWebServerRequest *request);
    void send_JTAG_configuration_html(AsyncWebServerRequest *request);
